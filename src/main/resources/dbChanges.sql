...
ALTER TABLE `spt`.`hr_employee_contract`
    CHANGE COLUMN `salary_date` `salary_day` INT NULL DEFAULT NULL ;
ALTER TABLE `spt`.`hr_employee_contract`
DROP FOREIGN KEY `fk_hr_employee_contract_hr_position1`;
ALTER TABLE `spt`.`hr_employee_contract`
DROP COLUMN `hr_position_id`,
DROP INDEX `fk_hr_employee_contract_hr_position_idx` ;
