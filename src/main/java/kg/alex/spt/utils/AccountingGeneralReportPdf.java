        ...
        source1 = new StreamResource.StreamSource() {
            ...
            public InputStream getStream() {
                ...
                try {
                    ...
                    Tdate.addCell(new Phrase("Дата: " + sysSettings.df.format(aDate), date_normal_font));
                    document.add(Tdate);
...
//                    document.add(new Paragraph(45, " "));
                    ...
                    accInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    accInfoTable.addCell(new Phrase(sysSettings.dFormat.format(sclAccInfo.getTotal_income()) + "$", normal_font));
                    accInfoTable.addCell(new Phrase(sclAccInfo.getLast_income_date(), normal_font));
                    accInfoTable.addCell(new Phrase(sysSettings.dFormat.format(sclAccInfo.getTotal_outcome()) + "$", normal_font));
                    accInfoTable.addCell(new Phrase(sclAccInfo.getLast_outcome_date(), normal_font));
                    accInfoTable.addCell(new Phrase(sysSettings.dFormat.format(sclAccInfo.getPrevious_balance()) + "$", normal_font));
                    accInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    accInfoTable.addCell(new Phrase(sysSettings.dFormat.format(sclAccInfo.getPrevious_balance() + sclAccInfo.getTotal_income()
                    ...
                    while (iter.hasNext()) {
                        ...
                        accTransTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                        accTransTable.addCell(new Phrase(sysSettings.dFormat.format((Double) accTransactionsTable.getContainerProperty(next,
                    ...
                    while (iter1.hasNext()) {
                        ...
                        inPaymentsTable.addCell(new Phrase(paymentsTable.getContainerProperty(next,
                                myUI.getMessage(SptMessages.Month)).getValue().toString(), normal_font));
                        inPaymentsTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                        inPaymentsTable.addCell(new Phrase(sysSettings.dFormat.format((Double) paymentsTable.getContainerProperty(next,
                                myUI.getMessage(SptMessages.InstallmentPlan)).getValue()), normal_font));
                        inPaymentsTable.addCell(new Phrase(sysSettings.dFormat.format((Double) paymentsTable.getContainerProperty(next,
                                myUI.getMessage(SptMessages.Payments)).getValue()), normal_font));
                        inPaymentsTable.addCell(new Phrase(sysSettings.dFormat.format((Double) paymentsTable.getContainerProperty(next,
