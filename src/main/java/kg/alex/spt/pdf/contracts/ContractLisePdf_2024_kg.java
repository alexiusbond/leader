...
public class ContractLisePdf_2024_kg {

    static final Logger logger = LogManager.getLogger(ContractLisePdf_2024_kg.class);
    ...
    public ContractLisePdf_2024_kg(final MyVaadinUI ui, StudentInfoPdf st_info, final IndexedContainer instPlanCont) {
        this.myUI = ui;
