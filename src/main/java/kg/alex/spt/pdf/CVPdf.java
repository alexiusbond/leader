        ...
        StreamResource.StreamSource source1 = new StreamResource.StreamSource() {
            ...
            public InputStream getStream() {
                ...
                try {
                    ...
                    cell = new PdfPCell(new Phrase(myUI.getMessage(SptMessages.MainInfo) + ": ", captionFont));
                    cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cell.setColspan(2);
                    cell.setBorder(0);
                    ...
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(SptMessages.Id), ordFont));
                    ...
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(SptMessages.LastName), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employee.getSurname(), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(SptMessages.FirstName), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employee.getName(), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(SptMessages.MiddleName), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employee.getMiddle_name() != null ? employee.getMiddle_name() : "", ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(SptMessages.Gender), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employeeExtraInfo.getGender(), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(SptMessages.DateAndPlaceOfBirth), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    ...
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(SptMessages.Nationality), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employeeExtraInfo.getNationality(), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(SptMessages.Citizenship), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employeeExtraInfo.getCitizenship(), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(SptMessages.MartialStatus), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    mainInfoTable.addCell(new Phrase(employeeExtraInfo.getMartialStatus(), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                    mainInfoTable.addCell(new Phrase(myUI.getMessage(SptMessages.HealthStatus), ordFont));
                    mainInfoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                    ...
                    paragraph = new Paragraph();
                    paragraph.setAlignment(Element.ALIGN_LEFT);
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.School) + ": ", ordFontBold));
                    ...
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.PhoneNumbers) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getPhones() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.Address) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getAddress() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.SpouseInfo) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getFamilyInfo() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.Children) + ": ", ordFontBold));
                    ...
                    paragraph = new Paragraph();
                    paragraph.setAlignment(Element.ALIGN_LEFT);
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.WorkingStatus) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getWorkingStatus() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.MainPosition) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getMainPosition() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.ExtraPositions) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getExtraPositions() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.TotalWorkExperience) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getWorkExperience() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.SapatWorkExperience) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getWorkExperienceSapat() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.MainBranch) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getMainBranch() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.ExtraBranches) + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getExtraBranches() + "\n", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.TotalHours) + year + ": ", ordFontBold));
                    paragraph.add(new Phrase(employeeExtraInfo.getHours() + " ", ordFont));
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.ExtraHours) + ": ", ordFontBold));
                    ...
                    if (currentUser.isPermitted(Settings.cnCV_Window + ":" + Settings.contract_info)) {
                        paragraph.add(new Phrase(myUI.getMessage(SptMessages.CanBeAdvisor) + ": ", ordFontBold));
                        paragraph.add(new Phrase(employeeExtraInfo.getCanBeAdvisor() + "\n", ordFont));
                        paragraph.add(new Phrase(myUI.getMessage(SptMessages.ContractType) + ": ", ordFontBold));
                        paragraph.add(new Phrase(employeeExtraInfo.getSalaryCategory() + "\n", ordFont));
                    }
                    paragraph.add(new Phrase(myUI.getMessage(SptMessages.Languages) + ": ", ordFontBold));
