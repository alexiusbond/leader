...
public class DebtsPdf {
    ...
    public DebtsPdf(final MyVaadinUI myUI, final IndexedContainer planCont, final String year,
        ...
        source1 = new StreamResource.StreamSource() {
            ...
            public InputStream getStream() {
                ...
                try {
                    ...
                    Tplan.addCell(new Phrase(" ", ordFontBold));
                    Tplan.addCell(new Phrase(" ", ordFontBold));
                    Tplan.addCell(new Phrase(Settings.dFormat.format(ttl_plan), ordFontBold));
                    Tplan.addCell(new Phrase(Settings.dFormat.format(total_paid), ordFontBold));
                    Tplan.addCell(new Phrase(Settings.dFormat.format(total_debt), ordFontBold));
        ...
        resource = new StreamResource(source1, "Debts"
