...
public class SptMessages_tr extends SptMessages {

    static final Object[][] contents_tr = {
            // Application
            {AppTitle, "SPT"},
            // Login Form
            {Language, "Язык"},
            ...
            {SalaryCategory, "Категория зарплаты"},
            ...
            {MovementsReport, "Отчет по передвижениям склада"},
            {Yearly, "Годовой"},
            {Monthly, "Месячный"},
            {Month, "Месяц"},
            {Months, "Месяцы"},
