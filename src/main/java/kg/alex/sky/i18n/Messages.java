...
public class Messages extends ListResourceBundle implements Serializable {
    ...
    public static final String SkyWorkExperience = generateId();
    ...
    public static final String Sky = generateId();
    ...
    public static final String SkyExam = generateId();
