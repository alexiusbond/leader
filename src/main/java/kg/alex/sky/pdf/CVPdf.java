...
import kg.alex.sky.domain.Employee;
import kg.alex.sky.domain.EmployeeExtraInfo;
        ...
        StreamResource.StreamSource source1 = new StreamResource.StreamSource() {
            ...
            public InputStream getStream() {
                ...
                try {
                    ...
                    paragraph.add(new Phrase(myUI.getMessage(Messages.SkyWorkExperience) + ": ", ordFontBold));
