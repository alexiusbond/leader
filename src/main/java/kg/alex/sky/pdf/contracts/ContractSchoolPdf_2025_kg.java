...
public class ContractSchoolPdf_2025_kg {

    static final Logger logger = LogManager.getLogger(ContractSchoolPdf_2025_kg.class);
    ...
    public ContractSchoolPdf_2025_kg(final MyVaadinUI ui, StudentInfoPdf st_info, final IndexedContainer instPlanCont) {
        this.myUI = ui;
        ...
        StreamResource.StreamSource source1 = () -> {
            ...
            try {
                ...
                paragraph.add(new Phrase(", бир тараптан, Кыргыз Республикасынын \"Билим берүү жөнүндө\" Мыйзамынын 4-беренесине ылайык окуучунун кызыкчылыгында мындан ары “Ата-энелер” деп аталуучу ", ordFont));
                ...
                paragraph.add(new Phrase(fullName + " " + studentInfo.getStudent().getClass_name(), ordBoldFont));
                paragraph.add(new Phrase(" классынын Окуучусунун ата-энелери ", ordFont));
