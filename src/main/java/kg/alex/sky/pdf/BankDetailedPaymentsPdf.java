...
public class BankDetailedPaymentsPdf {

    static final Logger logger = LogManager.getLogger(BankDetailedPaymentsPdf.class);
    private byte[] b = null;
    private ByteArrayOutputStream buffer = null;
    private Document document = null;

    public BankDetailedPaymentsPdf(final MyVaadinUI myUI, final IndexedContainer dataCont,
        ...
        StreamResource.StreamSource source1 = new StreamResource.StreamSource() {
            ...
            private final static String FONT_LOCATION = "/home/sky/PT_Sans-Web-Regular.ttf";
            private final static String FONT_LOCATION2 = "/home/sky/PT_Sans-Web-Bold.ttf";
            ...
            public InputStream getStream() {
                ...
                try {
                    ...
                    float[] table_colsWidth = {0.1f, 0.25f, 0.7f, 0.33f, 0.12f, 0.22f, 0.33f, 0.31f, 0.25f};
                    PdfPTable infoTable = new PdfPTable(9);
                    ...
                    infoTable.addCell(new Phrase(myUI.getMessage(Messages.StudentId), ordFontBold));
                    infoTable.addCell(new Phrase(myUI.getMessage(Messages.FullName), ordFontBold));
                    ...
                    infoTable.addCell(new Phrase(myUI.getMessage(Messages.TransactionNumber), ordFontBold));
                    infoTable.addCell(new Phrase(myUI.getMessage(Messages.Date), ordFontBold));
                    infoTable.addCell(new Phrase(myUI.getMessage(Messages.Status), ordFontBold));
                    ...
                    while (iter.hasNext()) {
                        ...
                        infoTable.addCell(new Phrase(dataCont.getContainerProperty(next,
                                myUI.getMessage(Messages.StudentId)).getValue().toString(), tableFont));
                        infoTable.addCell(new Phrase(dataCont.getContainerProperty(next,
                                myUI.getMessage(Messages.FullName)).getValue().toString(), tableFont));
                        ...
                        infoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
                        infoTable.addCell(new Phrase(Settings.dFormat4.format(dataCont.getContainerProperty(next,
                                myUI.getMessage(Messages.Rate)).getValue()), tableFont));
                        infoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                        infoTable.addCell(new Phrase(dataCont.getContainerProperty(next,
                                myUI.getMessage(Messages.TransactionNumber)).getValue().toString(), tableFont));
                        infoTable.addCell(new Phrase(dataCont.getContainerProperty(next,
                                myUI.getMessage(Messages.Date)).getValue().toString(), tableFont));
                        infoTable.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
                        infoTable.addCell(new Phrase(dataCont.getContainerProperty(next,
                                myUI.getMessage(Messages.Status)).getValue().toString(), tableFont));
                        i++;
                    }
                    infoTable.addCell(new Phrase("", ordFontBold));
                    infoTable.addCell(new Phrase("", ordFontBold));
