...
public class Messages extends ListResourceBundle implements Serializable {
    ...
    public static final String LeaderWorkExperience = generateId();
    ...
    public static final String Leader = generateId();
    ...
    public static final String LeaderExam = generateId();
