...
import kg.alex.leader.dao.DbExam;
import kg.alex.leader.domain.Exam;
...
public class ExamDefinitionView extends HorizontalSplitPanel implements Button.ClickListener,
    ...
    public ExamDefinitionView(MyVaadinUI myUI) {
        ...
        String[] NATURAL_COL_ORDER = new String[]{myUI.getMessage(Messages.Title),
                myUI.getMessage(Messages.ValidityMonths),
    ...
    private void buildSettingsLayout() {
        ...
        validityTF = new TextField(myUI.getMessage(Messages.ValidityMonths), property);
        validityTF.setStyleName(ValoTheme.TEXTFIELD_SMALL);
        validityTF.setRequired(true);
        validityTF.setRequiredError(myUI.getMessage(Messages.RequiredField));
    ...
    private void fillFields() {
        ...
        validityTF.getPropertyDataSource().setValue(dataTable.getContainerProperty(dataTable.getValue(),
                myUI.getMessage(Messages.ValidityMonths)).getValue());
    ...
    private void updateDataContainer() {
        ...
        dataTable.getContainerProperty(dataTable.getValue(),
                myUI.getMessage(Messages.ValidityMonths)).setValue(
    ...
    private void addDataContainerItem(int id) {
        ...
        item.getItemProperty(myUI.getMessage(Messages.Title)).setValue(
                nameTF.getValue());
        item.getItemProperty(myUI.getMessage(Messages.ValidityMonths)).setValue(
                validityTF.getPropertyDataSource().getValue());
