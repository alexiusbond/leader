...
import kg.alex.leader.dao.DbStock;
import kg.alex.leader.domain.Stock;
...
public class StockDefinitionView extends HorizontalSplitPanel implements Button.ClickListener,
    ...
    public StockDefinitionView(MyVaadinUI myUI) {
        ...
        String[] NATURAL_COL_ORDER = new String[]{myUI.getMessage(Messages.Title), myUI.getMessage(Messages.Status)};
        buildSettingsLayout();
