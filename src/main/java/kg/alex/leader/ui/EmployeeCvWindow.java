...
import kg.alex.leader.domain.Employee;
import kg.alex.leader.domain.EmployeeExtraInfo;
import kg.alex.leader.i18n.Messages;
import kg.alex.leader.pdf.CVPdf;
...
public class EmployeeCvWindow extends Window {
    ...
    public EmployeeCvWindow(MyVaadinUI myUI, Employee employee, EmployeeExtraInfo employeeExtraInfo, String year) {
        ...
        rowNum++;
        rightGl.addComponent(createLabel("<b>" +
                                         myUI.getMessage(Messages.LeaderWorkExperience) + ": </b>" + employeeExtraInfo.getWorkExperienceSapat(), null),
                0, rowNum, 1, rowNum);
        rowNum++;
        rightGl.addComponent(createLabel("<b>" +
