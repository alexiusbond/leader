...
import kg.alex.leader.dao.DbCurrencyRate;
import kg.alex.leader.dao.DbEmployeeMessage;
import kg.alex.leader.dao.DbSchool;
import kg.alex.leader.dao.DbUserDetails;
import kg.alex.leader.domain.UserDetails;
import kg.alex.leader.i18n.Messages;
import kg.alex.leader.ui.ViewManager;
...
public class MyVaadinUI extends UI {
    ...
    @VaadinServletConfiguration(productionMode = true,
            ui = MyVaadinUI.class, widgetset = "kg.alex.leader.AppWidgetSet")
