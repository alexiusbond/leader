...
import kg.alex.leader.dao.DbStudentOrder;
import kg.alex.leader.i18n.Messages;
import kg.alex.leader.reports.accounting.BankPaymentsByDateReport;
import kg.alex.leader.ui.*;
    ...
    private final Command menuCommand = new Command() {
        ...
        public void menuSelected(MenuItem selectedItem) {
            if (selectedItem != null) {
                ...
                if (eventPressed.equals(myUI.getMessage(Messages.YearDefinition))) {
