...
import kg.alex.leader.pdf.ClassInstallmentPlanPdf;
...
public class ClassInstPlanReport implements Button.ClickListener,
    ...
    public ClassInstPlanReport(final MyVaadinUI ui, final HorizontalSplitPanel splitPanel) {
        ...
        NATURAL_COL_ORDER = new String[]{
                ...
                myUI.getMessage(Messages.ClassName), myUI.getMessage(Messages.Phone),
        ...
        if (source == generateBtn) {
            ...
            try {
                if (dataTable.getContainerDataSource().size() != 0) {
                    ...
                    excelReport.setReportTitle(myUI.getMessage(Messages.InstallmentPLanPaymentsReport));
