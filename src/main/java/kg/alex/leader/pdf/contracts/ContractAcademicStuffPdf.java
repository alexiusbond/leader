...
import kg.alex.leader.domain.EmployeeInfoPdf;
import kg.alex.leader.utils.Decliner;
    ...
    public ContractAcademicStuffPdf(final MyVaadinUI myUi, EmployeeInfoPdf employeeInfo) {
        ...
        StreamResource.StreamSource source1 = () -> {
            ...
            try {
                ...
                paragraph.setLeading(15);
                paragraph.setAlignment(Element.ALIGN_JUSTIFIED);
                paragraph.add(new Phrase("2.2.18. не давать интервью журналистам СМИ о деятельности Учреждения и МОУ “Скай”.", ordFont));
                document.add(paragraph);
