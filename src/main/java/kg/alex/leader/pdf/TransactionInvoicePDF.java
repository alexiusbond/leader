...
import kg.alex.leader.utils.money.WritableSummRu;
import kg.alex.leader.utils.money.WritableSummRuSOM;
import kg.alex.leader.utils.money.WritableSummRuUSD;
    ...
    public TransactionInvoicePDF(final MyVaadinUI myUI, final AccTransaction tr, final String school,
        ...
        StreamResource.StreamSource source1 = () -> {
            ...
            try {
                ...
                final String FONT_LOCATION = "/home/leader/PT_Sans-Web-Regular.ttf";
                final String FONT_LOCATION_BOLD = "/home/leader/PT_Sans-Web-Bold.ttf";
