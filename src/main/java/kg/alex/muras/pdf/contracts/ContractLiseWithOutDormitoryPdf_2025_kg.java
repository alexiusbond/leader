...
public class ContractLiseWithOutDormitoryPdf_2025_kg {

    static final Logger logger = LogManager.getLogger(ContractLiseWithOutDormitoryPdf_2025_kg.class);
    ...
    public ContractLiseWithOutDormitoryPdf_2025_kg(final MyVaadinUI ui, StudentInfoPdf st_info, final IndexedContainer instPlanCont) {
        this.myUI = ui;
        ...
        StreamResource.StreamSource source1 = () -> {
            ...
            try {
                ...
                paragraph.add(new Phrase(" окуучуну окутуу, тарбиялоо процессин уюштуруу, анын мамлекеттик билим берүү стандартынын жана жалпы орто мектептин программаларынын алкагында билим алуусу саналат.", ordFont));
                document.add(paragraph);
                document.add(new Paragraph(10, " "));
                ...
                paragraph.clear();
                paragraph.add(new Phrase("2.1.5. Окуучуну жаш өзгөчөлүктөрүнө ылайык 3 маал тамак менен камсыз кылуу.", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.1.6. Лицейге алгачкы тапшырууда окуучуну бир жолу мектеп формасы менен камсыз кылуу, ал кийин зарылдыгына жараша ата-эненин эсебинен сатып алынууга тийиш.", ordFont));
                document.add(paragraph);
                ...
                paragraph.clear();
                paragraph.add(new Phrase("2.1.8. Кыргыз Республикасынын Билим берүү жана илим министрлиги бекиткен лицейдин окуу Планына ылайык, лицейдин Уставында белгиленген тартипте окуучунун жарым жылдык жана жылдык аттестациялоосун жүзөгө ашыруу.", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.1.9. Кыргыз Республикасынын Билим берүү жана илим министрлигинин жобосунун негизинде лицейдин педагогикалык кеңешинин чечими боюнча белгиленген тартипте окуучуну кийинки класска которуу.", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.1.10. Окуучу II баскычын ийгиликтүү аяктаган учурда күбөлүк, III баскычын аяктаганда - мамлекеттик үлгүдөгү аттестат берүү.", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.1.11. Окуучунун инсандыгын урматтоо, физикалык жана психологиялык зомбулукка жол бербөө, окуучунун жеке өзгөчөлүктөрүн эске алуу менен анын адеп-ахлактык, дене-бой жана психологиялык ден соолугун, эмоционалдык бейпилдигин чыңдоо шарттарын камсыз кылуу.", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.1.12. Медициналык квалификациясы документ менен тастыкталган лицейдин медициналык кызматкери тарабынан окуучунун ден соолугунун абалына учурдагы көзөмөлдү камсыз кылуу.", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.1.13. Окуучуну билим берүү чөйрөсүнүн коопсуздугу жана саламаттыгын сактоо боюнча талаптар камтылган лицейдин ички локалдык актылары жана \"Ички тартип эрежелери\" менен тааныштыруу.", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.1.14. Ар бир окуу чейрегинин жыйынтыгы боюнча ата-энеге окуучунун ден-соолугу, окуусу жана жүрүм-туруму жөнүндө маалымат берүү.", ordFont));
                document.add(paragraph);
                ...
                paragraph.clear();
                paragraph.add(new Phrase("а) лицейдин \"Ички тартип эрежелерин\" одоно, дайыма бузганда; (спирт ичимдиктерин, баңги каражаттарын, электрондук тамекилерди колдонуу, никотин камтыган каражаттарды колдонуу, кумар оюндарын ойноо, лицейдин аймагынан таанпис жана окуу сабактары учурунда уруксатсыз чыгып кетүү);", ordFont));
                document.add(paragraph);
                ...
                paragraph.clear();
                paragraph.add(new Phrase("2.2.6. Жүйөлүү себепсиз/45 күндүк окууну өткөрүп жиберген учурда, окуучу кайрадан окуу курсуна калат (экинчи жылга).", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.2.7. Эмгекке тарбиялоого компетенттүү мамиле кылуу максатында лицейдин администрациясы окуучуларды класстардагы өзүнүн жумуш ордун тазалоого тартууга укуктуу.", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.2.8. Лицей каалоо боюнча жана ата-энелер менен макулдашуу боюнча ЖРТ, TOEFL, SAT, IELTS ж.б. даярдоо курстарын, окуучулардын кызыкчылыктары боюнча ийрим ишин өзүнчө акы менен өткөрүүнү уюштурат. Ушуга байланыштуу Лицейдин администрациясы окуучуларга Лицейден тышкары кошумча билим берүү сабактарына катышууга тыюу салууга укуктуу.", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.2.9. Өнөкөт оорулар (эпилепсия, астма, жүрөк кемтиги, энурез ж.б.) боюнча диспансердик каттоодо турган окуучуларга өзгөчө шарттар берилбейт. Окуучулардын ата-энелери же мыйзамдуу өкүлдөрү окуучунун өнөкөт оорулары жөнүндө лицейдин медициналык кызматкерине жазуу жүзүндө эскертүүгө милдеттүү.", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.2.10. Ата-эненин демилгеси боюнча ушул келишимди бузууда ата-эненин ", ordFont));
                ...
                paragraph.clear();
                paragraph.add(new Phrase("2.2.11. Ушул келишим күтүлбөгөн жагдайлар боюнча бузулганда, лицейдин бардык чыгымдарын эске алуу менен кайтарылууга тийиш болгон сумма лицейдин мүмкүнчүлүгүнө жараша, бирок кийинки жылдын май айынан кечиктирилбестен кайтарылып берилет.", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.2.12. Билим берүү процессин жана лицейдин ишин кабарлоо максатында окуучуну жана ата-энелерди кабардар кылбастан фото жана видеоматериалдарды өздөрүнүн интернет баракчаларына жана ЖМКга жайгаштырат.", ordFont));
                document.add(paragraph);

                paragraph.clear();
                paragraph.add(new Phrase("2.2.13. Лицей КР мыйзамдарында каралган башка укуктарга ээ болушу мүмкүн.", ordFont));
                document.add(paragraph);
                ...
                paragraph.clear();
                paragraph.add(new Phrase("2.4.2. 2.2.9, 2.2.10-пункттарга ылайык окуучунун лицейде болгон мезгилинде окуу наркынын ордун толтуруу менен келишимди мөөнөтүнөн мурда бузуу.", ordFont));
                document.add(paragraph);
                document.add(new Paragraph(10, " "));
