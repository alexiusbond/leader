...
import kg.alex.muras.domain.EmployeeInfoPdf;
import kg.alex.muras.utils.Decliner;
import kg.alex.muras.utils.money.WritableSummRu;
import kg.alex.muras.utils.money.WritableSummRuSOM;
    ...
    public ContractAcademicStuffPdf(final MyVaadinUI myUi, EmployeeInfoPdf employeeInfo) {
        ...
        StreamResource.StreamSource source1 = () -> {
            ...
            try {
                ...
                paragraph.setLeading(15);
                paragraph.setAlignment(Element.ALIGN_JUSTIFIED);
                paragraph.add(new Phrase("2.2.18. не давать интервью журналистам СМИ о деятельности Учреждения и МОУ “Алтын Мурас”.", ordFont));
                document.add(paragraph);
