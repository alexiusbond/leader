...
import kg.alex.muras.dao.DbCurrencyRate;
import kg.alex.muras.dao.DbEmployeeMessage;
import kg.alex.muras.dao.DbSchool;
import kg.alex.muras.dao.DbUserDetails;
import kg.alex.muras.domain.UserDetails;
import kg.alex.muras.i18n.Messages;
import kg.alex.muras.ui.ViewManager;
...
public class MyVaadinUI extends UI {
    ...
    @VaadinServletConfiguration(productionMode = true,
            ui = MyVaadinUI.class, widgetset = "kg.alex.muras.AppWidgetSet")
