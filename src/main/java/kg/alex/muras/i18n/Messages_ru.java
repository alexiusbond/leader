...
public class Messages_ru extends kg.alex.muras.i18n.Messages {
    ...
    static final Object[][] contents_ru = {
            ...
            {NotificationNoPassportInfo, "Паспортные данные сотрудника отсутствуют"},
            {NotificationNoBranchInfo, "Не задана основная область преподавания"},
            {Date, "Дата"},
            ...
            {KindergartenContrRu, "Договор садик(RU)"},
            ...
            {Insert, "Добавить"},
            {Update, "Обновить"},
            {ChangeUserDataHeader, "Изменение информации"},
            ...
            {ExistsNotification, "Запись данной категории уже существует!"},
            ...
            {AggregatedReport, "Агрегированный отчет"},
