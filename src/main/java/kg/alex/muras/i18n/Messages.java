...
public class Messages extends ListResourceBundle implements Serializable {
    ...
    public static final String NotificationOrderDiscountLimit = generateId();
    ...
    public static final String PrimaryCode = generateId();
    public static final String SecondaryCode = generateId();
    ...
    public static final String AltynMurasWorkExperience = generateId();
    ...
    public static final String AltynMuras = generateId();
    ...
    public static final String KindergartenContrRu = generateId();
    public static final String LiseContrWithOutDormitoryRu = generateId();
    public static final String LiseContrWithOutDormitoryKg = generateId();
    ...
    public static final String NoDirectorAssigned = generateId();
    ...
    public static final String AltynMurasExam = generateId();
    ...
    public static final String ConfirmActionNotInLastYear = generateId();
    public static final String NotCurrentYear = generateId();
    ...
    public static final String OutOfAgreement = generateId();
    public static final String StudentIsNotOutOf = generateId();
    ...
    public static final String BalanceAccounts = generateId();
